...
<div class="container">
  <div class="grid sidebar-left clearfix">
    <div class="page-content">
      ...
      <p><img src="<?php echo e(asset('images/223-payment-logos.png')); ?>" alt="Payment types accepted"></p>
    ...
    <aside class="sidebar-promos">
      <div class="promo "> 
        ...
        <img src="<?php echo e(asset('images/15-pay-by-finance.svg')); ?>" width="252" height="37" alt="Our credit is provided by"> <br><br>
      ...
      <div class="promo "> 
        ...
        <img src="<?php echo e(asset('images/14-sectigo-ssl.png')); ?>" width="210" height="83" alt="You Are Safe &amp; Secure"> <br><br>
