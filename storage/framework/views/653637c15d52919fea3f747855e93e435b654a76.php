...
<head>
    ...
    <link href="<?php echo e(asset('assets/css/payment.css')); ?>" rel="stylesheet" />
</head>
    ...
    <div class="st-content">
        <div id="st-block-standard-details" class="st-block-standard st-layout-clear">
            <div id="st-block-standard-orderdetails" class="st-layout-halfwidth st-layout-floatleft">
                <img id="merchant-logo" src="<?php echo e(asset('images/VanityCLUB-Logotype-White.png')); ?>">
...
</html><?php /**PATH C:\xampp\htdocs\carplatemarket\resources\views\frontend\payment_details.blade.php ENDPATH**/ ?>