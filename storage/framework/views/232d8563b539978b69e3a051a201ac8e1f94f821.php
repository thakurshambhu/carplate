...
<?php echo $__env->make('layouts.home-header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
 <!--breadcrumbs area start-->
    ...
    <div class="product_details mt-20">
        <div class="container">
            <?php if(!empty($plate_detail)): ?>
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <div class="product-details-tab">

                        <div id="img-1" class="zoomWrapper single-zoom">
                            <a href="#"><?php echo e($plate_detail->plate_number); ?>

                                <!-- <img id="zoom1" src="<?php if(!empty($plate_detail->plateimage->media_url)): ?><?php echo e($plate_detail->plateimage->media_url); ?><?php endif; ?>" data-zoom-image="assets/img/product/product15.jpg" alt="big-1"> -->
                            </a>
                            <div class="action_links1">
                                <ul>
                            
                                    <li class="wishlist"><a href="javascript:void()" class ="save_plate" data-plate-id="<?php echo e($plate_detail->id); ?>" title="Add to Wishlist"><span class="lnr lnr-heart"></span></a></li>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product_d_right">
                        <form action="#">
                            ...
                            <div class="price_box">
                                <span class="current_price">$<?php echo e($plate_detail->plate_price); ?></span>
                            ...
                            <div class="product_variant quantity">
                               ...
                               <button class="button add_item_to_cart" type="button" data-plate-id=<?php echo e($plate_detail->id); ?>>add to cart</button>
                               <?php if(Auth::user()): ?>
                                <a href="<?php echo e(url('cart')); ?>"><button class="button " type="button" >Checkout</button></a>
                                <?php else: ?>
                                   
                                      <a href="<?php echo e(route('login')); ?>"><button class="button " type="button" >Checkout</button></a>
                                <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\carplatemarket\resources\views\frontend\plate_detail.blade.php ENDPATH**/ ?>