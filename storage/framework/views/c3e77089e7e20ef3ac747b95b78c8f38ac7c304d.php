...
<div class="container">
  <div class="grid sidebar-left clearfix">
    <div class="page-content">
      ...
      <p><img src="https://www.carreg.co.uk/assets/media/223-payment-logos.png" alt="Payment types accepted"></p>
    ...
    <aside class="sidebar-promos">
      <div class="promo "> 
        ...
        <img src="https://www.carreg.co.uk/assets/promos/15-pay-by-finance.svg" width="252" height="37" alt="Our credit is provided by"> <br><br>
      ...
      <div class="promo "> 
        ...
        <img src="https://www.carreg.co.uk/assets/promos/14-sectigo-ssl.png" width="210" height="83" alt="You Are Safe &amp; Secure"> <br><br>
...
<?php echo $__env->make('layouts.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\carplatemarket\resources\views\frontend\payments.blade.php ENDPATH**/ ?>