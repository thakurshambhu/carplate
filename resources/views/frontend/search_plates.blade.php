        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    @if(!empty($search_plates))
                        @foreach($search_plates as $key=>$plate)
                                  ...
                                  -->
                                    ...
                                    <!-- <div class="action_links">
                                        <ul>
                                            ...
                                            <li class="wishlist"><a href="javascript:void()" class ="save_plate" data-plate-id="{{$plate->id}}" title="Add to Wishlist"><span class="lnr lnr-heart"></span></a></li>
                                ...
                                <div class="product_content grid_content">
                                    <div class="content_inner">
                                        ...
                                        <div class="product_footer d-flex align-items-center">
                                            <div class="price_box">
                                                 <a class="view_plate"  href="javascript:void()" data-toggle="modal" data-target="#modal_box" title="quick view" view-plate-id="{{$plate->id}}" >VIEW</a>
                                            </div>
                                            <div class="price_box">
                                                <span class="current_price">${{$plate->plate_price}}</span>
                                            </div>
                                            <!-- <div class="add_to_cart">
                                                <a href="javascript:void(0)" class="add_item_to_cart" title="add to cart" data-plate-id={{$plate->id}}><span class="lnr lnr-cart"></span></a>
                                            </div> -->
                                        </div>
                                    </div>
                                </div>
