...
<div class="container">
    <div class="intro  grayBg">
        ...
        @if(!empty($plate_record))
        <div class="priceBlock">
            <h3 class="plate">{{$plate_record->plate_number}}</h3>
            <div class="priceSummary pt-2">
                <ul>
                    <li>
                        <label>Plate number Price:</label>
                        <span class="value">${{$plate_record->plate_price}}</span>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <span class="value"><strong>${{$plate_record->plate_price}}</strong></span>
                    </li>
                </ul>
            </div>
        </div>
   ...
   <div class="contact-area">
    <div class="row">
        <div class="col-md-8 col-lg-9">
            ...
            <form  method="POST" action="{{url('/shipping_address')}}" id="contact-us-form">
              @csrf
                <div class="form-row">
                           ...
                           <!--  <tbody>
                            ...
                            <tfoot>
                                <tr>
                                    <td>TOTAL</td>
                                    <td>
                                        $<b id="total-holder">{{$plate_record->plate_price}}</b>
                                    </td>
                                </tr>
                            </tfoot>
                        </table>
        ...
        <div class="col-md-4 col-lg-3">
            <div class="contact_message content">
                <aside class="sidebar">
                    ...
                    <img src="{{asset('images/37-affiliate-logos.png')}}" width="330" height="53" alt="Proud Members of" class="mb-3">
                    ...
                    <img src="{{asset('images/14-sectigo-ssl.png')}}" width="210" height="83" alt="You Are Safe &amp; Secure" class="mb-3">
