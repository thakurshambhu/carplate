            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-3">
                        <div class="logo">
                            <a href="{{url('/')}}"><img src="{{asset('images/VanityCLUB-Logotype-V2.png')}}" alt=""></a>
                        </div>
                    </div>
                        ...
                        <div class="middel_right">
                            ...
                            <div class="middel_right_info">
                                ...
                                <div class="header_wishlist">
                                    <a href="{{url('saved-plate')}}"><span class="lnr lnr-heart"></span> Wish list </a>
                                    <span class="wishlist_quantity saved_count">{{session('saved_count')}}</span>
                                </div>
                                <div class="mini_cart_wrapper">
                                    <a href="{{url('cart')}}"><span class="lnr lnr-cart"></span>My Cart </a>
                                    <span class="cart_quantity cart_count">{{session('cart_count')}}</span>
